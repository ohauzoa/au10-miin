...
void sunxifb_flush(lv_disp_drv_t *drv, const lv_area_t *area,
                   lv_color_t *color_p)
{
    if (fbp == NULL || area->x2 < 0 || area->y2 < 0 || area->x1 > (int32_t)fbp_w - 1 || area->y1 > (int32_t)fbp_h - 1)
    {
...
{
#if defined(LV_USE_SUNXIFB_G2D_FILL) || defined(LV_USE_SUNXIFB_G2D_BLIT) || defined(LV_USE_SUNXIFB_G2D_BLEND) || defined(LV_USE_SUNXIFB_G2D_SCALE)
