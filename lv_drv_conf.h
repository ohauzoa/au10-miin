...
//#define LV_USE_SUNXIFB_DEBUG           1
#define LV_USE_SUNXIFB_G2D_BLEND           1
#define LV_USE_SUNXIFB_G2D_FILL           1
#define LV_USE_SUNXIFB_G2D_BLIT           1
#define LV_USE_SUNXIFB_G2D_SCALE           1
